...
*/
    ...
    function social_bookmarks($content) {
        ...
        // facebook
        $content .= '<li class="facebook" style="margin-left:-30px;"><div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="" send="false" layout="button_count" show_faces="false" font=""></fb:like></li>' ;
        // google plus
        ...
        // pinterest
        $content .= '<li class="pinterest" style="margin-left:-30px;"><script type="text/javascript" src="//assets.pinterest.com/js/pinit.js"></script><a href="#" class="pin-it-button" count-layout="horizontal"><img border="0" src="//assets.pinterest.com/images/PinExt.png" title="Pin It" /></a></li>' ;
        $content .= '</ul>' ;
        // clear
    ...
    function social_bookmarks_header( ) {
        ...
        if($location == 'item' && $section == '') {
            ...
            <style type="text/css">
                ...
                .social-bookmarks ul li { float: left; margin-right:10px;padding:0;padding-right:5px; }
