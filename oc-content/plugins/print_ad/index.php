...
function print_ad() {
    ...
    $price = strip_tags(osc_item_formated_price());
	...
	<input type="hidden" name="site_url" value="'.osc_base_url().'">
        ...
        <a id="print_ad" title="' . __('Print this listing safely', 'print_ad') . '" class="print" href="#" onClick="formpopup();document.printform.submit();return false;"><i class="fa fa-print"></i></a>
    </form>
